...
<div class="news-image-form">
    ...
    <?= $form->field($model, 'namaFoto')->textInput(['maxlength' => true, 'placeholder'=>'Untuk Gambar utama wajib diberikan judul title dengan ukuran 900px X 300px dan tipe data .jpg; Jangan ada gambar dengan nama Foto yang sama']) ?>
